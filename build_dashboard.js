...
const bannerDarkSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 350" width="100%" height="100%">
  <defs>
    ...
    <pattern id="photo-grid" width="12" height="12" patternUnits="userSpaceOnUse">
      <path d="M 12 0 L 0 0 0 12" fill="none" stroke="#00e5ff" stroke-opacity="0.14" stroke-width="0.5" />
    </pattern>

    <linearGradient id="photo-scan-grad" x1="0%" y1="0%" x2="0%" y2="100%">
  ...
  <g transform="translate(16, 46)">
    ...
    <rect x="5" y="5" width="270" height="278" fill="url(#photo-grid)" clip-path="url(#user-portrait-clip)" opacity="0.22" />
    <rect x="5" y="5" width="270" height="278" fill="url(#photo-scan-grad)" clip-path="url(#user-portrait-clip)" class="photo-scan" />
